...
| [Q](note-Q-dictionary.md) | Note O in bipartite-Diophantine language | *added* | the sets coincide, so the O-thread is about BD2(-1) generally; the joint-ratio gap principle is non-vacuous where the standard one is not |
